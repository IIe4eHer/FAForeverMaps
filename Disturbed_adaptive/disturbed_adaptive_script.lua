...
local Tables = import("/maps/Disturbed_adaptive.v0006/Disturbed_adaptive_tables.lua")
...
local extra_hydros = ScenarioInfo.Options.extra_hydros or 2
local extra_mexes = ScenarioInfo.Options.extra_mexes or 1
local middle_mexes = ScenarioInfo.Options.middle_mexes or 4
...
function gatherFeedback()
    WaitSeconds(10)
    BroadcastMSG('If you discover any map-related bugs, pls tell the map author. Discord c0_okieZ#5230. Thx.',  -- message
                 16,                                                             -- fontsize
                 'd0d0d0',                                                       -- color
                 5,                                                             -- duration
                 'center')                                                       -- position
