...

{
    ...
    values = {
        ...
        { text = "3", help = "<LOC adaptive_middle_mex_key_3_help> Spawn 3 mexes in the middle.", key = 2, },
        { text = "7", help = "<LOC adaptive_middle_mex_key_7_help> Spawn 7 mexes in the middle.", key = 3, },
        { text = "11", help = "<LOC adaptive_middle_mex_key_11_help> Spawn 11 mexes in the middle.", key = 4, },
    },
},
